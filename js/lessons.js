      ...
      steps: [
        {
          ...
          prompt: 'A fork is one move that creates TWO winning threats, so your opponent cannot stop both. Find a fork.',
          correct: [2, 3, 7, 8],
          explainOk: 'That is a fork — one move that makes two winning threats at once, so O can only block one and you win with the other.',
          hint: 'Look for a square that lines up with two of your pieces in two different directions. More than one square works here.',
        },
        {
          board: b([2, 4], [3, 7]), toMove: 'X',
          prompt: 'Find a move that makes two threats at once.',
          correct: [1, 2, 6, 9],
          explainOk: 'That is a fork — two winning threats from a single move, and O cannot block both.',
          hint: 'A corner can join a row/column AND a diagonal at the same time. Several squares create a fork here.',
        },
        {
          board: b([0, 4], [1, 7]), toMove: 'X',
          prompt: 'One more fork to spot.',
          correct: [3, 4, 6, 7],
          explainOk: 'Two threats, one move — that is a fork. O can only stop one of them.',
          hint: 'Look for a square that joins two of your lines at once — more than one square qualifies here.',
        },
      ],
    },
    {
